...
const iconTheme = 'fa-sun'; // This will be used to check for 'fa-sun' for light mode and 'fa-moon' for dark mode
...
themeButton.addEventListener('click', () => {
    ...
    localStorage.setItem('selected-icon', newTheme === 'dark' ? 'fa-moon' : 'fa-sun');
});
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.hero__data, .hero__image, .about__data, .about__skills, .project__card, .contact__information, .contact__form');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (heroTitle) {
        ...
        setTimeout(() => {
            ...
            // For this demo, we'll just fade in instead of typing effect
            // to avoid complexity with HTML structure
        }, 500);
    }
});
...
function createParticles() {
    ...
    function animate() {
        ...
        particles.forEach(particle => {
            ...
            ctx.fillStyle = getComputedStyle(document.documentElement).getPropertyValue('--first-color');
            ctx.fill();
        });
